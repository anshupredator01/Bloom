        ...
        return object: CountDownTimer(minutes * 60000, 1000) {
            ...
            override fun onTick(ms: Long) {
                ...
                if(((startMin == 10L && minutes == 9L) || minutes == 19L) && sec == 55L) {
                    speak("Take a deep breathe and clam yourself")
                }

                if(minutes == 2L && sec == 10L) {
                    speak("Take calm breathe and relax your body you are now charged. Don't Open your eyes.")
                }

                if(minutes == 0L && sec == 10L) {
                    speak("Silently Open Your Eyes")
                }
